...
namespace Yolo
{
    //可以在声明的时候就定义并且初始化，在程序运行之前就把相关变量直接替换为变量的对应值
...
//    static constexpr int IMG_W = 640;
    ...
    static constexpr int IMG_H = 320;
...
//        virtual int enqueue(int32_t batchSize, const void*const * inputs, void** outputs, void* workspace, cudaStream_t stream) noexcept override;

        virtual int32_t enqueue(int32_t batchSize, const void* const *inputs, void* const* outputs, void* workspace,
