...
int main(int argc, char** argv) {
    ...
    std::string wts_name = "/home/fjy/Desktop/py_ws/YOLOP/toolkits/deploy/yolop.wts";
    std::string engine_name = "/home/fjy/Desktop/py_ws/YOLOP/toolkits/deploy/yolop_fp16.engine";
