...
//    out.convertTo(tensor, CV_32FC3, 1.f);
...
{
    static const std::vector<cv::Vec3b> segColor{cv::Vec3b(100, 100, 0), cv::Vec3b(0, 255, 0), cv::Vec3b(205, 200, 0),cv::Vec3b(65, 80, 80),cv::Vec3b(255, 100, 100)};
